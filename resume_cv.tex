...
\name{\textbf{Gurnoor}}{Singh}
\address{HNO 13 ST NO 1 Dhandra Road Baba Deep Singh Nagar, Basant Avenue, Ludhiana, Punjab - 141013}
\mobile{(+91) 9501023463}

\email{gurnoor30196@gmail.com}
%\homepage{www.posquit0.com}
\github{gurnoor30196}
\linkedin{Gurnoor Singh}

\extrainfo{Blog:-https://gurnoor30.wordpress.com/}
%\skype{skypeid}
%\stackoverflow{SOid}{SOname}
\wordpress{gurnoor30}
%\linkedin{linkedin name}
%\reddit{reddit account}
\homepage{www.singhgurnoor.com}
%\extrainfo{test} % Other text you want to include on this line

\position{Student} % Your expertise/fields
%\quote{``There are 10 types of people in this world, those who understand binary and those %who dont"} % A quote or statement

\makecvfooter{\today}{Gurnoor Singh~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
